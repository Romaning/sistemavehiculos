    ...
    <div class="block shadow p-2 mb-1 rounded" data-toggle="appear" data-class="animated bounceIn">
        ...
        <div class="block-content">
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons">
                <thead>
                <tr>
                    <th class="d-sm-table-cell">GESTION</th>
                    <th class="d-none d-sm-table-cell">DESCRIPCION</th>
                    <th class="d-sm-table-cell">EMPRESA ASEGURADORA</th>
                    <th class="d-sm-table-cell">FECHA DE VIGENCIA</th>
        ...
        <div>
            <table class="table table-bordered table-striped table-vcenter {{--js-dataTable-buttons--}}">
                ...
                <tr>
                    ...
                    <th class="d-sm-table-cell">FECHA MANTENIMIENTO</th>
                    <th class="d-none d-sm-table-cell">PLACA</th>
                    <th class="d-none d-sm-table-cell">DEATALLE MANT</th>
                    <th class="d-sm-table-cell">TIPO MANT</th>
                    <th class="d-sm-table-cell">EMPRESA ENCARGADA</th>
    ...
    <div class="block shadow p-2 mb-1 rounded" data-toggle="appear" data-class="animated bounceIn">
        ...
        <div>
            <table class="table table-bordered table-striped table-vcenter ">
                <thead>
                <tr>
                    <th class="d-sm-table-cell">FECHA ENTREGA</th>
                    <th style="width:10%" class="text-sm-center font-size-sm">
                        {{--<a href="{{route('mantenimiento.create')}}"
                           class="btn-sm btn-primary shadow rounded">
                            <i class="fa fa-plus-circle"></i> Añadir
        ...
        <div>
            <table class="table table-bordered table-striped table-vcenter {{--js-dataTable-buttons--}}">
                ...
                <tr>
                    <th class="d-none d-sm-table-cell">ID</th>
                    <th class="d-none d-sm-table-cell">PLACA</th>
                    <th class="d-sm-table-cell">CI</th>
                    <th class="d-sm-table-cell">TIPO INCIDENCIA</th>
        ...
        <div>
            <table class="table table-bordered table-striped table-vcenter{{-- js-dataTable-buttons--}}">
                ...
                <tr>
                    ...
                    <th class="d-sm-table-cell">FECHA</th>
                    ...
                    <th class="d-sm-table-cell">DESCRIPCION</th>
                    <th class="d-sm-table-cell">MONTO</th>
                    <th style="width:10%" class="text-sm-center font-size-sm">
