        ...
        <div class="block-content block-content-full block invisible shadow rounded" data-toggle="appear"
            ...
            <div>
                <table class="table table-bordered table-striped table-vcenter js-dataTable-buttons"
                    ...
                    <thead>
                    <tr>
                        <th class="d-sm-table-cell">N° PLACA</th>
                        ...
                        <th class="d-sm-table-cell">Marca</th>
                        <th class="d-sm-table-cell">Estado Serv</th>
                    ...
                    @foreach($datosvehiculos as $filavehiculos)
                        <tr>
                            ...
                            <td class="align-items-center disabled justify-content-center">
